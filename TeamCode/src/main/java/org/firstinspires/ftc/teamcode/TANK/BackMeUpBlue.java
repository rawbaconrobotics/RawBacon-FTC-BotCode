...
@Autonomous(name="BackMeUpBlue", group="Pushbot")
public class BackMeUpBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(-0.6, -67.5, -67.5, 2.5);
        sleep(500);
        encoderDrive(0.6, -15, 15, 1);
        sleep(500);
        encoderDrive(0.6, 17.5, 17.5, 0.65);
        sleep(500);
        encoderDrive(0.6, 15, -15, 1);
        sleep(500);
        encoderDrive(0.6, 47.5, 47.5, 1.7);
        sleep(500);
        encoderDrive(-0.6, -10, -10, 0.4);
        sleep(500);
        encoderDrive(0.6, 15, -15, 1);
        sleep(500);
        encoderDrive(0.6, 30, 30, 1.1);
