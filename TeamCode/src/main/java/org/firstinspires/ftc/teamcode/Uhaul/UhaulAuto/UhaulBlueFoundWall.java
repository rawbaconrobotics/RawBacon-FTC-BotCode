...
public class UhaulBlueFoundWall extends UhaulLinearOpMode {
    ...
    public void run() {
        ...
        robot.drive.strafeFor(SECONDstrafeinches,0.2,false, 10);
        sleep(250);

        robot.drive.strafeFor(THIRDstrafeinches,0.2,true, 10);
        sleep(250);

        robot.drive.driveFor(FOURTHdriveinches,0.5,10);
        sleep(250);

        robot.drive.strafeFor(FIFTHstrafeinches,0.2, false, 10);
        sleep(250);
        ...
        robot.drive.strafeFor(NINTHstrafeinches,0.5,true, 10);
