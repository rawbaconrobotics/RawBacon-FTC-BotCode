 ...
 */
 ...
 //20 560
@Config
@Autonomous(name= "BDAuto_ParkingOnly_Blue", group="Tank")

public class BDAuto_ParkingOnly_Blue extends BaseLinearOpMode {
    ...
    public void on_init() {
      ...
      //  phoneCam.startStreaming(rows, cols, OpenCvCameraRotation.UPRIGHT);//display on RC
        ...
        webcam.setPipeline(new BDAuto_ParkingOnly_Blue.StageSwitchingPipeline());//different stages
