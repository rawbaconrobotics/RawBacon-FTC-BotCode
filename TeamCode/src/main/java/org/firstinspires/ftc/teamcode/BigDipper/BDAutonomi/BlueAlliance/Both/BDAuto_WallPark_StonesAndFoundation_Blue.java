...
@Config
@Disabled
@Autonomous(name= "BDAuto_WallPark_StonesAndFoundation_Blue", group="Tank")

public class BDAuto_WallPark_StonesAndFoundation_Blue extends BaseLinearOpMode {
    ...
    public void on_init() {
      ...
      //  phoneCam.startStreaming(rows, cols, OpenCvCameraRotation.UPRIGHT);//display on RC
        ...
        webcam.setPipeline(new BDAuto_WallPark_StonesAndFoundation_Blue.StageSwitchingPipeline());//different stages
