...
@Autonomous(name="TankEncoderRed", group="Tank")
public class TankEncoderRed extends TankLinearOpMode {
    ...
    public void run(){
        ...
        robot.encoderDrive(15, DRIVE_SPEED * 1.5, DRIVE_SPEED * 1, DRIVE_SPEED * 1.5, DRIVE_SPEED * 1,5);
        sleep(500);
