 ...
 */
 ...
 //20 560
@Config
@Autonomous(name= "BDAuto_ParkingOnly_Red", group="Tank Red")

public class BDAuto_ParkingOnly_Red extends BaseLinearOpMode {
    ...
    public void on_init() {
      ...
      //  phoneCam.startStreaming(rows, cols, OpenCvCameraRotation.UPRIGHT);//display on RC
        ...
        webcam.setPipeline(new BDAuto_ParkingOnly_Red.StageSwitchingPipeline());//different stages
